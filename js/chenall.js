...
function load_random_posts(obj){
  ...
  var html = '<ul class="widget-list-group">';
  $.each(arr,function(index,item){html += '<li class="widget-list-group-item"><a href="'+site.BASE_URI+ item.uri + '">' + (item.title || item.uri) + '</a></li>';});
  $(obj).html(html + '</ul>');
}
...
//  });
    ...
    $(".hm-menu").click(function(){
        if($(".hm-menu-left-container").hasClass('zhankai')){
            ...
            $(".collapse").hide();
            $('#content').removeClass('zhankai').addClass("shouqi");
